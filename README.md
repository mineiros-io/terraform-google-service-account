...
- **`account_id`**: **_(Required `string`)_**
...
- **`projects_access`**: _(Optional `list(projects_access)`)_
  ...
  Each `projects_access` object accepts the following fields:
...
- **`folders_access`**: _(Optional `list(folders_access)`)_
  ...
  Each `folders_access` object accepts the following fields:
...
- **`organization_access`**: _(Optional `object(organization_access)`)_
  ...
  Each `organization_access` object accepts the following fields:

  - **`org_id`**: **_(Required `string`)_**
